...
Hello!
<br>
Welcome to `fox kit 🦊🐾`'s **terms of service**!
...
### » The privacy policy 📩
› Before you continue, you're advised to read `fox kit 🦊🐾`'s own **[privacy policy](https://magicalbunny31.github.io/discord-bun-bot-public/fox-kit/privacy-policy "https://magicalbunny31.github.io/discord-bun-bot-public/fox-kit/privacy-policy 🔗
fox kit 🦊🐾's privacy policy")** regarding the data the bot collects.


### » Rules of conduct 📒
› `fox kit 🦊🐾` provides you with a service of its commands.
<br>
...
### » You, as the user 👤
› You are solely responsible for what you do with `fox kit 🦊🐾`.
<br>
› `fox kit 🦊🐾` is not liable for any activities from your account.
<br>
› The developer, [magicalbunny31](https://magicalbunny31.github.io "https://magicalbunny31.github.io 🔗
magicalbunny31's website 🐾"), reserves the right to terminate your access to using `fox kit 🦊🐾` at any time.


### » Copyright 🐺
› Content published with `fox kit 🦊🐾` (whether that be images, texts, logos..) is property of the developer, [magicalbunny31](https://magicalbunny31.github.io "https://magicalbunny31.github.io 🔗
...
### » Third-party content 🌐
› `fox kit 🦊🐾` uses third-parties to help provide with its service.
<br>
› The developer does not endorse them or are liable for their actions.
<br>
› Any links that lead to these third-party websites will make you leave `fox kit 🦊🐾`'s service, and you will be subject to the site's own terms of service and privacy policy.
...
› The terms of service can be found via one of `fox kit 🦊🐾`'s slash commands: **`/terms-of-service`**
<br>
